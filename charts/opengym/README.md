...
| api | object | `{"image":{"digest":"","pullPolicy":"IfNotPresent","repository":"registry.gitlab.com/duartesantos8/opengym/api","tag":"1.2.11"},"livenessProbe":{"initialDelaySeconds":10,"periodSeconds":15,"tcpSocket":{"port":"http"}},"port":3000,"readinessProbe":{"initialDelaySeconds":3,"periodSeconds":5,"tcpSocket":{"port":"http"}},"replicaCount":1,"resources":{"limits":{"memory":"512Mi"},"requests":{"cpu":"100m","memory":"128Mi"}},"service":{"annotations":{},"type":"ClusterIP"}}` | API workload configuration. |
...
| ingress | object | `{"annotations":{},"className":"","enabled":false,"extraPaths":[],"extraRules":[],"extraTls":[],"host":"","path":"/","pathType":"Prefix","tls":{"enabled":false,"secretName":""}}` | Ingress configuration. |
...
| media | object | `{"accessModes":["ReadWriteOnce"],"annotations":{},"loader":{"enabled":true,"image":"alpine/git","imagePullPolicy":"IfNotPresent","repository":"https://github.com/hasaneyldrm/exercises-dataset"},"storage":"512Mi","storageClassName":""}` | Shared exercise media volume configuration. |
...
| web | object | `{"containerPort":80,"image":{"digest":"","pullPolicy":"IfNotPresent","repository":"registry.gitlab.com/duartesantos8/opengym/web","tag":"1.2.11"},"readinessProbe":{"initialDelaySeconds":3,"periodSeconds":5,"tcpSocket":{"port":"http"}},"replicaCount":1,"resources":{"limits":{"memory":"256Mi"},"requests":{"cpu":"100m","memory":"128Mi"}},"securityContext":{"allowPrivilegeEscalation":false,"capabilities":{"add":["CHOWN","SETGID","SETUID"],"drop":["ALL"]}},"service":{"annotations":{},"port":8080,"type":"ClusterIP"}}` | Web workload configuration. |
